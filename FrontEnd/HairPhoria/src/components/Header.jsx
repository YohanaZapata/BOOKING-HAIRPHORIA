  ...
  return (
    <>
      <div className={`header ${menuOpen ? "menuOpen" : ""}`}>
        <div className="logo">
          <Link onClick={reloadPage} to={routes.home} className="link">
        ...
        {isLoggedIn ? (
          <div className={`profileLogIn ${menuOpen ? "leftChange" : ""}`}>
            ...
            <Link className="seeProfile" to={routes.dashboard + "/profile"} onClick={reloadPage}>Ver perfil</Link>
          </div>
        ...
        <div class="custom-shape-divider-top-1687562584">
